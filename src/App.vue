<template>
	<div
		id="app"
		class="flex flex-col h-screen w-screen justify-center items-center text-center"
	>
		<h1 class="text-5xl uppercase font-bold">Destiny Reset Clock</h1>
		<h2 class="text-4xl uppercase">Next Weekly Reset</h2>
		<Ticker
